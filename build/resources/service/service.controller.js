...
var ServiceCtrl = /** @class */ (function () {
    function ServiceCtrl() {
        ...
        this.getAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.serviceServ.getAllServices()];
                    case 1:
                        services = _a.sent();
        ...
        this.allRoutes = function () {
            _this.route.get(_this.path, _this.getAll);
        };
        this.path = '/service';
        this.route = express_1.Router();
        this.allRoutes();
        this.serviceServ = new service_service_1.ServiceServ();
    }
    return ServiceCtrl;
}());
